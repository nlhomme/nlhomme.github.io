...
/**
 * @file index.php
 * @author Nicolas LHOMME <contact@lhomme.xyz>
 * @version 1.0 Mai 2025
 *
 * Trèèès libre reprise du script de lecture de flux RSS France 24
 * https://github.com/nlhomme/minipaviCli/blob/main/France24/index.php
 * 
 */
	...
	while(true) {
		switch ($step) {
			case 'accueil':
				...
				$vdt.= file_get_contents('nlhomme.vdt');
				$vdt.=MiniPavi\MiniPaviCli::setPos(21,8);
				$vdt.=VDT_G0.VDT_TXTYELLOW.VDT_BGBLUE.VDT_SZDBLH.VDT_BLINK." Nicolas";
				$vdt.=MiniPavi\MiniPaviCli::setPos(21,10);
				$vdt.=VDT_G0.VDT_TXTYELLOW.VDT_BGBLUE.VDT_SZDBLH.VDT_BLINK.MiniPavi\MiniPaviCli::toG2(" LHOMME");
				
				$vdt.=MiniPavi\MiniPaviCli::setPos(1,24);
				$vdt.=VDT_G0.VDT_TXTWHITE.VDT_BGBLACK.MiniPavi\MiniPaviCli::toG2(" Pour aller au CV, tapez ").VDT_FDINV." Suite ".VDT_FDNORM.VDT_CLRLN;
			...
			case 'rubriques':
				...
				$vdt.=VDT_SZDBLH.VDT_TXTWHITE.VDT_BGBLUE.' Nicolas LHOMME'.VDT_TXTBLACK.chr(hexdec('7D')).VDT_TXTWHITE.VDT_BGRED.' SRE/DevOps'.VDT_CLRLN;
				...
				$vdt.=VDT_BGGREEN.VDT_TXTBLACK.' '.VDT_SZDBLW."Compétences informatiques".VDT_SZNORM.' ';

				$vdt.=MiniPavi\MiniPaviCli::setPos(8,8);
				$vdt.=VDT_BGGREEN.VDT_TXTBLACK.' '.VDT_SZDBLW."Expériences Professionnelles".VDT_SZNORM.' ';

				$vdt.=MiniPavi\MiniPaviCli::setPos(8,10);
				$vdt.=VDT_BGGREEN.VDT_TXTBLACK.' '.VDT_SZDBLW."Diplômes et formations".VDT_SZNORM.' ';
				
				$vdt.=MiniPavi\MiniPaviCli::setPos(8,12);
				$vdt.=VDT_BGGREEN.VDT_TXTBLACK.' '.VDT_SZDBLW."Loisirs".VDT_SZNORM.' ';
				
				$vdt.=MiniPavi\MiniPaviCli::setPos(8,14);
				$vdt.=VDT_BGGREEN.VDT_TXTBLACK.' '.VDT_SZDBLW."Coordonnées".VDT_SZNORM.' ';

				
				$vdt.=MiniPavi\MiniPaviCli::setPos(7,21);
				$vdt.=VDT_BGYELLOW.VDT_TXTBLUE."Plus d'informations";
				$vdt.=MiniPavi\MiniPaviCli::setPos(8,22);
				$vdt.=VDT_BGYELLOW.VDT_TXTBLUE."sur linkedin.com/in/nlhomme";
