...
date: 2023-11-29T13:00:00+02:00
categories: [Open source, Succès déverrouillé]
tags: [open source]
---

> Dans cet article je raconte une histoire. Dans un souci d'accessibilité au plus grand nombre, les aspects techniques sont volontairement pas ou peu détaillés.
...
![Une GitHub Action, c'est très simple](/assets/img/posts/2023-07-24-participe_projet_open_source/cest-tres-simple.jpg)

C'est un fichier contenant des instructions suivies par GitHub.
On peut faire un tas de choses avec une GitHub Action, par exemple lors de l'ajout d'une fonction à une application, l'Action va :
...
## Spellcheck, meilleur ami du rédacteur

[Spellcheck](https://github.com/rojopolis/spellcheck-github-actions) est une GitHub Action développée par [Robert 'rojopolis' Jordan](https://github.com/rojopolis). Son but est de parcourir les fichiers contenant du texte, et de relever des fautes de langue (français, anglais, etc.) et de langage technique (Python, Markdown, etc.).
...
![Une action qui marche quand ça ne devrait pas](/assets/img/posts/2023-07-24-participe_projet_open_source/1-action-false-success.png)
...
Sauf que le résultat attendu est que l'Action, parce qu'elle a repéré des fautes, renvoie un signal d'échec.
...
![Le correctif, en couleurs](/assets/img/posts/2023-07-24-participe_projet_open_source/2-pr-fix.png)
...
![Notes de version mentionnant nlhomme](/assets/img/posts/2023-07-24-participe_projet_open_source/3-release-notes.png)
...
C'est aussi trouver des problèmes que les développeurs n'ont pas vus ou anticipés. Leur rapporter avec suffisamment de détails va les guider dans leurs investigations et corriger le problème le plus vite possible, évitant que davantage de monde ne soit impacté.

![Succès déverrouillé : participer à un projet open source](/assets/img/posts/2023-07-24-participe_projet_open_source/4-achievement.png)
...
C'est exactement la démarche que j'ai suivie avec le projet [Homebrew Cask](https://github.com/Homebrew/homebrew-cask), un gestionnaire de paquet pour macOS. La mise à jour du logiciel « Sublime Text » n'était pas possible à cause d'une erreur de vérification de la mise à jour.
J'ai analysé l'erreur, l'ai traitée et [envoyé le correctif](https://github.com/Homebrew/homebrew-cask/pull/152315) aux développeurs.
